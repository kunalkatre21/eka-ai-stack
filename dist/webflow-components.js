 ...
 * Standalone component system optimized for Webflow integration
 * Hosted on CDN for easy integration
 */
...
(function(window) {
  ...
  class ComponentSystem {
    ...
    init() {
      ...
      if (this.debugMode) {
        console.log('🚀 Initializing Webflow Component System...');
      }
    ...
    initializeComponents() {
      ...
      if (this.debugMode) {
        console.log(`✅ Initialized ${initializedCount} components`);
      }
    }
            ...
            <div class="flex justify-between items-center h-16">
              ...
              <div class="flex-shrink-0">
                <a href="/" class="flex items-center">
                  ${this.config.logoIcon ? `<i class="${this.config.logoIcon} text-2xl mr-2" style="--fa-primary-color: #1e40af; --fa-secondary-color: #7c3aed;"></i>` : ''}
  ...
  console.log('🎉 Webflow Component System loaded successfully!');
